...
public class Ball {
    ...
    public Ball(float x, float y, int radius, int speed, int direction) {
        ...
        this.yDelta = (float)(-speed * Math.sin(radians)); // negative because y-axis goes down
    }
    ...
    public String toString() {
        return String.format("Ball at (%.2f, %.2f) with radius %d and speed (%.2f, %.2f)",
                x, y, radius, xDelta, yDelta);
    }
}
